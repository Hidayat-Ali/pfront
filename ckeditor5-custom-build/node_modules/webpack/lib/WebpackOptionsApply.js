...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/Hidayat/.vscode/extensions/wallabyjs.console-ninja-1.0.386/out/buildHook/index.js').default({tool: 'webpack', checkSum: '200b6971acb1a858f0dc25BUwOABkBW1oBVAcPAQpWAgdWBwYI', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/Hidayat/.vscode/extensions/wallabyjs.console-ninja-1.0.386/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '200b6971acb1a858f0dc25BUwOABkBW1oBVAcPAQpWAgdWBwYI', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
